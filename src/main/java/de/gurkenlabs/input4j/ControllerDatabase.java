...
public final class ControllerDatabase {
  ...
  private static Map<Integer, ControllerInfo> buildBuiltInDatabase() {
    return Map.ofEntries(
        ...
        entry(0x045E, 0x02E3, "Xbox One Elite Wireless Controller", ControllerType.XBOX),
        entry(0x045E, 0x0B00, "Xbox One Elite Wireless Controller Series 2", ControllerType.XBOX),
